...
<header class="header" data-header>
    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="searchblog.php" class="navbar-link" data-nav-link>Notice</a>
          </li>
  ...
  <a class="add_btn" href="notice_add.html">add</a>
...
<table class="table table-hover text-center ">
  ...
  <tr>
        ...
        <td><a class="del_btn"  href="notice_delete.php?id=<?php echo $row["id"]; ?>">Delete</a></td>
